...
function createSkillRuntimeCheck(skillRuntime) {
  if (skillRuntime && typeof skillRuntime.find === "function" && typeof skillRuntime.activate === "function") {
    ...
    return {
      ...
      summary: supportsResources
        ? "AgentSkill runtime is injected; skill_find, skill_activate, and skill_resource are available; skill_create and skill_remove additionally require explicit tool selection."
  ...
  return {
    id: "tool.skill_runtime",
    status: "warn",
    summary: "AgentSkill runtime is not injected; skill_find, skill_create, skill_remove, skill_activate, and skill_resource will not be exposed.",
