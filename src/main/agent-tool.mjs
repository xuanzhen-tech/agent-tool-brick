...
function selectModelToolSchemas({ config, runtimeDependencies, skillRuntime, terminalManager, ecommerceImageRuntime, ecommerceVideoRuntime, selectedTools, toolProviders }) {
  ...
  add(ECOMMERCE_VIDEO_STATUS_TOOL, Boolean(ecommerceVideoRuntime));
  add(ECOMMERCE_VIDEO_CANCEL_TOOL, Boolean(ecommerceVideoRuntime));
  add(ECOMMERCE_VIDEO_RETRY_TOOL, Boolean(ecommerceVideoRuntime));
  add(ECOMMERCE_VIDEO_LIST_TOOL, Boolean(ecommerceVideoRuntime));
  add(SPREADSHEET_INSPECT_TOOL, Boolean(config.pythonBin));
  add(SPREADSHEET_COMPUTE_TOOL, Boolean(config.pythonBin));
  add(SPREADSHEET_VALIDATE_TOOL, Boolean(config.pythonBin));
